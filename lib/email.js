  ...
  const html = `
    <div style="font-family:sans-serif;max-width:560px;margin:auto;color:#222">
      ...
      <div style="border:1px solid #eee;border-top:none;padding:24px;border-radius:0 0 8px 8px">
        ...
        <!-- Forward to a friend -->
        <div style="margin-top:28px;padding:16px;background:#f8f9fa;border-radius:8px;text-align:center">
          <p style="margin:0 0 10px;font-size:14px;color:#444;font-weight:600">
            💰 Kennst du jemanden der auch sparen will?
          </p>
          <p style="margin:0 0 12px;font-size:13px;color:#888">
            Leite diese E-Mail einfach weiter — kostenlos, ein Klick.
          </p>
          <a href="mailto:?subject=Schau%20mal%20%E2%80%93%20g%C3%BCnstige%20Preise%20auf%20Preisgucken.de&body=Hey%2C%0A%0Aich%20nutze%20Preisgucken.de%20um%20Preise%20zu%20vergleichen%20und%20Geld%20zu%20sparen.%0A%0ATäglich%20neue%20Angebote%20aus%20deutschen%20Online-Shops%20-%20kostenlos%20und%20ohne%20Anmeldung.%0A%0ASchau%20mal%20rein%3A%20https%3A%2F%2Fwww.preisgucken.de%0A%0AViele%20Grüße"
             style="display:inline-block;background:#F07D00;color:#fff;padding:10px 24px;border-radius:6px;text-decoration:none;font-weight:bold;font-size:14px">
