...
CREATE TABLE IF NOT EXISTS b2b_registrations (
  ...
  hauptniederlassung_abweichend   BOOLEAN DEFAULT FALSE,
  hauptniederlassung_strasse      TEXT,
  hauptniederlassung_plz          TEXT,
  hauptniederlassung_ort          TEXT,
  hauptniederlassung_land         TEXT,
  website                         TEXT,
